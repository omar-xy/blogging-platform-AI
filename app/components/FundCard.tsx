...
const FundCard = ({ owner, title, description, handleClick, timePosted, likes } : any) => {
  ...
  const shortDescription = description.length > 60 ? description.substring(0, 60) + "...more" : description;

  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer hover:scale-105 transition-transform duration-300" onClick={handleClick}>
      <div className="flex flex-col p-4">
        ...
        {/* Description */}
        <p className="mt-[5px] text-[#808191] text-[14px] leading-[18px] truncate">
          {shortDescription}
        </p>
